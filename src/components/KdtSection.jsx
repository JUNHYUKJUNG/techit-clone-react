...
const KdtSection = () => {
  return (
    <section className="mt-20 container">
      ...
      <div className="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 justify-items-center mt-10">
        {/* // 반응형 : grid-cols-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4} */}
        {kdtCardData.map((v, i) => (
          <KdtCard
            key={i}
            image={v.image}
